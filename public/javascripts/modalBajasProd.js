...
// Select DOM
var modalTriggersDom = document.querySelectorAll('.BotonER');
...
function openModal(e) {
  if (e.target && e.target.classList.contains('BotonER')) {
    trigger = e.target;
...
function cancelModal(e) {
  if (e.target && e.target.classList.contains('BotonReg') && !isClosing) {
    e.stopPropagation();
    isClosing = true;
